...
As previously mentioned, Uber has adopted the concept of monorepos for the vast majority of their codebases. Within the usage of monorepos, there are a number of scenarios where disk performance is relevant.
