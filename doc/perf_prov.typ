...
This chapter investigates raw disk performance in various scenarios, by performing a number of experiments. In this section, we briefly describe the technical details of how these experiments are performed.
